...
struct PlayerConfig
{
    ...
    const XMFLOAT3 COLLIDER_SCALE = XMFLOAT3(PLAYER_SCALE * 40.0f, PLAYER_SCALE * 160.0f, PLAYER_SCALE * 70.0f);

    // 攻撃コライダーのオフセット
	const XMFLOAT3 ATTACK_COLLIDER_BASE_POS = XMFLOAT3(0.0f, 0.0f, 35.0f);
	const XMFLOAT3 ATTACK_COLLIDER_SCALE = XMFLOAT3(PLAYER_SCALE * 40.0f, PLAYER_SCALE * 80.0f, PLAYER_SCALE * 200.0f);
